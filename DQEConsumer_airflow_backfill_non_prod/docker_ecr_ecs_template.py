...
mainDir = 'DQEConsumer_airflow_backfill_non_prod'
NAME = mainDir.lower()
dagName = NAME

## dag for redshift query
DIR_NAME = mainDir
task_id = NAME
...
with DAG(dagName, default_args=default_args, schedule_interval="0 5 * * 4", catchup=False,max_active_runs=1) as dag:
